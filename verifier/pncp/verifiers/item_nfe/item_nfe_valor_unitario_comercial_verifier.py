...
class ItemNfeValorUnitarioComercialVerifier(BaseVerifier):
    """Verifier for the 'valor_unitario_comercial' field in the 'item_nfe' table."""
    destination_field = "valor_unitario_comercial"
