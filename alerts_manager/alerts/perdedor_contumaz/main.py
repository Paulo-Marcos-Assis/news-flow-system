...
class AlertaBasicoPerdedorContumaz(BaseAlert):

    alert_type = "alerta_basico_perdedor_contumaz"
        ...
        try:
            ...
            if result:
                execucao_alerta["alerta"] = {
                    ...
                    "nivel": 2,
                    "descricao_longa": f"A pessoa {id_objeto} é um perdedor contumaz.",
                    "descricao_curta": f"A pessoa {id_objeto} é um perdedor contumaz.",
